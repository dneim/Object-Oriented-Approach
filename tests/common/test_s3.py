...
class TestS3BucketConnectorMethods(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        """
        # mocking s3 connection termination
        self.mock_s3.stop()

    def test_list_in_files_prefix_ok(self):
        """
        Tests the list_in_files_prefix method for getting 2 file keys
    ...
    def test_list_files_in_prefix_wrong_prefix(self):
        """
        Tests the list_in_files_prefix method in case of a
        wrong or non-existent prefexi
        """
        # Expected results
