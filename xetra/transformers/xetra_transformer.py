...
class XetraTargetConfig(NamedTuple):
    """
    Class target configuration data
    ...
    trg_col_clo_price: column name for closing price in target
...
class XetraETL():
    """
    Reads the Xetra data, transforms data, and writes to target
    """
